...
func (LoggingFunc) CreateAsyncLoggingFunc(level string, logType string, message string, method, path, ip, query string, code models.ErrorCode, user_agent string, data map[string]any, stack string) {
