...
var (
	...
	WorkflowEdgesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{WorkflowEdgesColumns[15]},
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "workflowedge_application_id",
				Unique:  false,
				Columns: []*schema.Column{WorkflowEdgesColumns[15]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{WorkflowEdgesColumns[9]},
			},
		},
	}
	...
	WorkflowNodesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{WorkflowNodesColumns[8]},
			},
		},
	}
