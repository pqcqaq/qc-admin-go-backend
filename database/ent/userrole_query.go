...
func (_q *UserRoleQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserRoleQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *UserRoleQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *UserRoleQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *UserRoleQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *UserRoleQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserRoleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserRole, init func(*UserRole), assign func(*UserRole, *User)) error {
	...
	nodeids := make(map[uint64][]*UserRole)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *UserRoleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userrole.Table, userrole.Columns, sqlgraph.NewFieldSpec(userrole.FieldID, field.TypeUint64))
	_spec.From = _q.sql
