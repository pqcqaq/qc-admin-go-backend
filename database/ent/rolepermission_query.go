...
func (_q *RolePermissionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *RolePermissionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *RolePermissionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *RolePermissionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *RolePermissionQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *RolePermissionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(rolepermission.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.RolePermission.Query().
//		Select(rolepermission.FieldCreateTime).
//		Scan(ctx, &v)
