...
func (_c *RolePermissionCreate) SetCreateTime(v time.Time) *RolePermissionCreate {
	_c.mutation.SetCreateTime(v)
	return _c
}

// SetNillableCreateTime sets the "create_time" field if the given value is not nil.
func (_c *RolePermissionCreate) SetNillableCreateTime(v *time.Time) *RolePermissionCreate {
	if v != nil {
		_c.SetCreateTime(*v)
	}
	return _c
...
func (_c *RolePermissionCreate) SetUpdateTime(v time.Time) *RolePermissionCreate {
	_c.mutation.SetUpdateTime(v)
	return _c
}

// SetNillableUpdateTime sets the "update_time" field if the given value is not nil.
func (_c *RolePermissionCreate) SetNillableUpdateTime(v *time.Time) *RolePermissionCreate {
	if v != nil {
		_c.SetUpdateTime(*v)
	}
	return _c
...
func (_c *RolePermissionCreate) SetDeleteTime(v time.Time) *RolePermissionCreate {
	_c.mutation.SetDeleteTime(v)
	return _c
}

// SetNillableDeleteTime sets the "delete_time" field if the given value is not nil.
func (_c *RolePermissionCreate) SetNillableDeleteTime(v *time.Time) *RolePermissionCreate {
	if v != nil {
		_c.SetDeleteTime(*v)
	}
	return _c
...
func (_c *RolePermissionCreate) SetPermissionID(v uint64) *RolePermissionCreate {
...
func (_c *RolePermissionCreate) defaults() error {
	if _, ok := _c.mutation.CreateTime(); !ok {
		if rolepermission.DefaultCreateTime == nil {
			return fmt.Errorf("ent: uninitialized rolepermission.DefaultCreateTime (forgotten import ent/runtime?)")
		}
		v := rolepermission.DefaultCreateTime()
		_c.mutation.SetCreateTime(v)
	}
	if _, ok := _c.mutation.UpdateTime(); !ok {
		if rolepermission.DefaultUpdateTime == nil {
			return fmt.Errorf("ent: uninitialized rolepermission.DefaultUpdateTime (forgotten import ent/runtime?)")
		}
		v := rolepermission.DefaultUpdateTime()
		_c.mutation.SetUpdateTime(v)
	}
	return nil
}
...
func (_c *RolePermissionCreate) check() error {
	if _, ok := _c.mutation.CreateTime(); !ok {
		return &ValidationError{Name: "create_time", err: errors.New(`ent: missing required field "RolePermission.create_time"`)}
	}
	if _, ok := _c.mutation.UpdateTime(); !ok {
		return &ValidationError{Name: "update_time", err: errors.New(`ent: missing required field "RolePermission.update_time"`)}
	}
...
func (_c *RolePermissionCreate) createSpec() (*RolePermission, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CreateTime(); ok {
		_spec.SetField(rolepermission.FieldCreateTime, field.TypeTime, value)
