...
func (_q *CredentialQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CredentialQuery) FirstIDX(ctx context.Context) uint64 {
...
func (_q *CredentialQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (_q *CredentialQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (_q *CredentialQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (_q *CredentialQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(credential.FieldCreateTime).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Credential.Query().
//		Select(credential.FieldCreateTime).
//		Scan(ctx, &v)
...
func (_q *CredentialQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Credential, init func(*Credential), assign func(*Credential, *User)) error {
	...
	nodeids := make(map[uint64][]*Credential)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *CredentialQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(credential.Table, credential.Columns, sqlgraph.NewFieldSpec(credential.FieldID, field.TypeUint64))
	_spec.From = _q.sql
