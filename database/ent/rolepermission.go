...
func (*RolePermission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case rolepermission.FieldID, rolepermission.FieldCreateBy, rolepermission.FieldUpdateBy, rolepermission.FieldDeleteBy, rolepermission.FieldRoleID, rolepermission.FieldPermissionID:
			values[i] = new(sql.NullInt64)
		case rolepermission.FieldCreateTime, rolepermission.FieldUpdateTime, rolepermission.FieldDeleteTime:
	...
	for i := range columns {
		...
		case rolepermission.FieldPermissionID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.PermissionID = uint64(value.Int64)
			}
		default:
